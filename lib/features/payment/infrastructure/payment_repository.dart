...
print('Expiry: ${payment.expiryDate}');
    if (payment.amount <= 0) return left(const PaymentFailure.invalidAmount());
    ...
    if (payment.paymentMethod == 'card') {
      ...
      if (payment.cardNumber != null && !_isValidCardNumber(payment.cardNumber!)) {
        return left(const PaymentFailure.invalidCard());
      }

      if (payment.expiryDate != null && !_isValidExpiryDate(payment.expiryDate!)) {
